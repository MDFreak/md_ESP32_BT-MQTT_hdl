               ...
               bluetti_device_state[i].f_offset + bluetti_device_state[i].f_size-1 <= (offset + length)/2
                ...
                switch (bluetti_device_state[i].f_type){
                  ...
                  case UINT_FIELD:
                    ...
                    SVAL(bluetti_device_state[i].f_name, String(parse_uint_field(data_payload_field)));
                    break;

                  case BOOL_FIELD:
                    //publishTopic(bluetti_device_state[i].f_name, String((int)parse_bool_field(data_payload_field)));
                    SVAL(bluetti_device_state[i].f_name, String((int)parse_bool_field(data_payload_field)));
                    break;
                  ...
                  case DECIMAL_FIELD:
                    ...
                    SVAL(bluetti_device_state[i].f_name, String(parse_decimal_field(data_payload_field, bluetti_device_state[i].f_scale ), 2) );
                    break;
                  ...
                  case SN_FIELD:
                    ...
                    SVAL(bluetti_device_state[i].f_name, String(sn));
                    break;

                  case VERSION_FIELD:
                    //publishTopic(bluetti_device_state[i].f_name, String(parse_version_field(data_payload_field),2) );
                    SVAL(bluetti_device_state[i].f_name, String(parse_version_field(data_payload_field),2) );
                    break;

                  case STRING_FIELD:
                    //publishTopic(bluetti_device_state[i].f_name, parse_string_field(data_payload_field));
                    SVAL(bluetti_device_state[i].f_name, parse_string_field(data_payload_field));
                    break;

                  case ENUM_FIELD:
                    //publishTopic(bluetti_device_state[i].f_name, pase_enum_field(data_payload_field));
                    SVAL(bluetti_device_state[i].f_name, pase_enum_field(data_payload_field));
                    break;
                  default:
                    break;
